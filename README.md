...
This project was developed for hackathon purposes. Add a license of your choice (MIT recommended for open-source hackathon projects) before public release.
